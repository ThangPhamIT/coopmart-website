...
const PLEASE_ENTER_YOUR_FULL_NAME = 'THÔNG TIN CÁ NHÂN';
const FULL_NAME_PLACE_HOLDER = 'NGUYỄN VĂN A';
const USER_NAME_CAN_NOT_BE_EMPTY = 'HỌ VÀ TÊN KHÔNG ĐƯỢC ĐỂ TRỐNG';
const PLEASE_SELECT_YOUR_DEPARTMENT = 'BỘ PHẬN BẠN LÀM VIỆC';
...
const BEFORE_TIME_UP = 'THỜI GIAN LÀM BÀI CÒN 3 PHÚT';
...
const DEPARTMENT_TITLE = 'BỘ PHẬN';
